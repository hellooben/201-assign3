OBJS = integer.o real.o string.o sll.o dll.o queue.o stack.o dll-*-*.o binomial-*-*.o binomial.o
OPTS = -Wall -Wextra -std=c99
EXECS = test-dll test-binomial
EXTRAS = integer.c real.c string.c queue.c sll.c stack.c
OEXTRAS = integer.o real.o string.o queue.o sll.o stack.o
...
test-binomial :
	gcc $(OPTS) -c binomial.c dll.c $(EXTRAS) binomial-2-0.c
	gcc $(OPTS) binomial-2-0.o $(OEXTRAS) dll.o binomial.o -o test-binomial
